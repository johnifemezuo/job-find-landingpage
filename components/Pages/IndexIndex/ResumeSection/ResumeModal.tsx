...
export default function ResumeModal() {
  ...
  return (
    <>
      <Transition appear show={play} as={Fragment}>
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-auto  transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-2">
                    <iframe
                      className="w-full h-auto md:w-[700px] lg:w-[1000px] md:h-[400px] lg:h-[600px]"
                      src="https://www.youtube.com/embed/HoxfUs-wrrI"
